...
public partial class Player {
    ...
    void JumpTpMove()
    {
        ...
        if (m_Prediction.m_HitStringPoint != Vector3.zero)
        {
            ...
            if (Physics.CheckSphere(m_Prediction.m_HitStringPoint, 6f, playerLayer))
            {
                //回避行動
                ...
                else if (Physics.CheckSphere(m_Prediction.m_HitStringPoint, 0.15f, playerLayer) && !isEscape)
                {
                    //waitFrame = 0;
